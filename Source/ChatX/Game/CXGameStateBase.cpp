...
FString ACXGameStateBase::GenerateSecretNumber()
{
...
bool ACXGameStateBase::IsGuessNumberString(const FString& InNumberString)
{
	bool bCanPlay = false;
...
FString ACXGameStateBase::JudgeResult(const FString& InSecretNumberString, const FString& InGuessNumberString)
{
